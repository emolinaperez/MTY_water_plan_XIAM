...
# in PC
 ...
 dir.output<-"C:\\Users\\L03054557\\OneDrive\\Edmundo-ITESM\\3.Proyectos\\ProyectoAguaMty\\Phase2MTY\\ExperimentsRawOutput\\VulnerabilityAnalysis\\"
...
#Load Demand Scenarios Table
  ...
  Demand.Scenarios.Table<-subset(Demand.Scenarios.Table,WaterTarrifs=="Current")
...
Vulnerability.NoAction<-vulnerability.eval(dir.model,
                                           ...
                                           rep(0,15),
                                           rep(0,15),
                                           unique(Futures.Table$Future.ID)[2])
...
#  write.csv(Vulnerability.NoAction,paste(dir.output,"Vulnerability_NoAction.csv",sep=""),row.names=FALSE)
  write.csv(Vulnerability.NoAction,paste(dir.output,"Vulnerability_NoAction_test.csv",sep=""),row.names=FALSE)

#merge with original file
  dir.file <- "C:\\Users\\L03054557\\OneDrive\\Edmundo-ITESM\\3.Proyectos\\ProyectoAguaMty\\Phase2MTY\\ExperimentsDataTables\\"
  file.1<-read.csv(paste(dir.file,"VulnerablityAdaptivePlans.csv",sep=""))

#
 testNO<-  Vulnerability.NoAction
 testNO$Reliability.NO <- testNO$Reliability
 test<-Reduce(function(...) { merge(...,all.x=FALSE) }, list( file.1,testNO[,c("Period","Future.ID","Reliability.NO")]))

 write.csv(test,paste(dir.file,"Vulnerability_Add_NO.csv",sep=""),row.names=FALSE)
...
# in PC
 dir.model<-"C:\\Users\\L03054557\\OneDrive\\Edmundo-ITESM\\3.Proyectos\\ProyectoAguaMty\\Phase2MTY\\ModeloRiverware\\"
 dir.output<-"C:\\Users\\L03054557\\OneDrive\\Edmundo-ITESM\\3.Proyectos\\ProyectoAguaMty\\Phase2MTY\\ExperimentsRawOutput\\VulnerabilityAnalysis\\P1\\"
 dir.exp<-"C:\\Users\\L03054557\\OneDrive\\Edmundo-ITESM\\3.Proyectos\\ProyectoAguaMty\\Phase2MTY\\ExperimentsDataTables\\"
 dir.scenarios<-"C:\\Users\\L03054557\\OneDrive\\Edmundo-ITESM\\3.Proyectos\\ProyectoAguaMty\\Phase2MTY\\Scenarios\\"
...
dir.output<-"C:\\Users\\L03054557\\OneDrive\\Edmundo-ITESM\\3.Proyectos\\ProyectoAguaMty\\Phase2MTY\\ExperimentsRawOutput\\VulnerabilityAnalysis\\AdaptivePlan\\"
...
#rbind all blocks
 ...
 dir.output<-"C:\\Users\\L03054557\\OneDrive\\Edmundo-ITESM\\3.Proyectos\\ProyectoAguaMty\\Phase2MTY\\ExperimentsDataTables\\"
...
#Vulnerability of doing nothing
dir.vulnerability<-"C:\\Users\\L03054557\\OneDrive\\Edmundo-ITESM\\3.Proyectos\\ProyectoAguaMty\\Phase2MTY\\ExperimentsRawOutput\\VulnerabilityAnalysis\\"
