...
#save options table
 ...
 write.csv(Vulnerability.P1,paste(dir.output,"P1_OptionsTable_14_01_2018_block1_tarriffs.csv",sep=""),row.names=FALSE)
...
#write step 1 options
 write.csv(step1.options,paste(dir.output,"step1_options_14_01_2018.csv",sep=""),row.names=FALSE)
...
#using clasification algos to understand the database
 ...
 Portfolios<-read.csv(paste(dir.data,"OptimalPortfolios_09_01_2018_Step2.csv",sep=""))
 all.names<-colnames(Portfolios)[1:15]
...
#using clasification algos to understand the database
 ...
 Portfolios<-read.csv(paste(dir.data,"OptimalPortfolios_14_01_2018_Step2.csv",sep=""))
 all.names<-colnames(Portfolios)[1:15]
