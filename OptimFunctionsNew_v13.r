...
#Split the experimento into #n number of computers
 sequence.of.runs<-1:unique(Futures.Table$Future.ID)
 Total.machines<-20
...
#
 dir.portfolios<-"C:\\Users\\L03054557\\OneDrive - Instituto Tecnologico y de Estudios Superiores de Monterrey\\Edmundo-ITESM\\Proyectos\\ProyectoAguaMty\\Phase2MTY\\ExperimentsRawOutput\\DynamicOptimalPortfolios\\Experiment_05_01_2018_Step_1\\"
...
#write result
  ...
  write.csv(OptimalPortfolios,paste(dir.output,"OptimalPortfolios_05_01_2017.csv",sep=""),row.names=FALSE)
